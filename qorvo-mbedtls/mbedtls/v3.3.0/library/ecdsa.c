 ...
 */
#ifdef FIXME //SW-9259
// Modification Qorvo: expose the restartable variant of mbedtls_ecdsa_verify by removing the "static" keyword
// Next version of mbedTLS will have this function exposed
#endif
